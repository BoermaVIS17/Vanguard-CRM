/**
 * Vanguard Systems (VIS) Brand Constants
...
export const BRAND_COLORS = {
  ...
  navy: '#001F3F',        // Secondary - Deep Navy Blue from logo
  darkBlue: '#003366',    // Accent - Dark Blue
  silver: '#C0C0C0',      // Metallic Silver from shield
  slate: '#1e293b',       // Background slate
} as const;
